        ...
        <ModalMain aria-hidden id="modal">
            <LoginWrap onClick={(e) => e.stopPropagation()} aria-hidden>
                ...
                <LoginMain>
                    <ButtonStyle
                        id="kakao"
                        href={`https://kauth.kakao.com/oauth/authorize?client_id=e2d1c7ba92ca798e88509878ae8f44ee&redirect_uri=${selectDevOrProductUrl}/auth/kakaologin&response_type=code`}
                    >
                        <svg
                            width="22"
                            height="20"
